...
export default function Signup_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $Signup_Styles_Service extends Component {
            constructor(props) {
                super(props)
