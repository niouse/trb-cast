...
export default function Login_Styles_Service(computeStyles, defaultStyles, stylesOptions) {
    return (WrappedComponent) => {
        var stylesOptionsSub

        class $Login_Styles_Service extends Component {
            constructor(props) {
                super(props)
